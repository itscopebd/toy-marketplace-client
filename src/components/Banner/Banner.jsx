            ...
            <div id="slide1" className="carousel-item relative w-full">
                <img src={banner1} className="w-full" />
                    ...
                    <div className='top-1/2 left-2/3 -translate-x-1/2 -translate-y-1/2 absolute w-8/12 text-center'>
                        ...
                        <p className='my-3 hidden md:flex'>There's some innocent flirtation between boy and girl cars. <br /> Some mild language -- at least one use of "hell." At 116 minutes, <br /> it's on the long side for animation and may be too much for some really little kids.</p>
